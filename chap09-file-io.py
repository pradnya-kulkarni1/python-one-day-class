...
print(f"readline() :{contents}") # prints first line from the file

#there are also absolute path and relative path 
# in this case, it is gonna look in same folder
...
olympic_athletes = ["Simone Biles", "Michael Phelps", "Michael Johnson", "Chloe Kim","P T Usha", "Sachin Tendulkar", "Djokovic"]
